...
DROP TABLE IF EXISTS "CardFromBooster" CASCADE;
DROP TABLE IF EXISTS "BoosterPurchase" CASCADE;
DROP TABLE IF EXISTS "CollectedCard" CASCADE;
DROP TABLE IF EXISTS "BoosterConfig" CASCADE;
...
DROP TYPE IF EXISTS "BoosterType" CASCADE;
...
-- Insert initial set
INSERT INTO "Set" ("code", "name", "description", "updatedAt")
VALUES ('XPRCHT', 'Xprcht', 'Set initial de TCG Xprcht', NOW());

-- Insert initial booster configs
